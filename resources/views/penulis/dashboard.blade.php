        ...
        @foreach ($atk as $a)
            ...
            <div
                ...
                <div class="flex h-auto w-full mb-2">
                    @if($a->foto)
                        <img src="{{ asset('uploads/' . $a->foto) }}" alt="Nama" class="h-40 object-cover w-full rounded-t-md">
                    @else
                ...
                <div class="text-md overflow-ellipsis break-all cursor-default truncate"
                ...
                <div class="flex flex-row justify-between mt-5 b-0">
                    <a href="{{ route('show.artikel', ['id' => $a->id]) }}"
                        class="p-2 px-4 bg-slate-900 hover:bg-slate-800 rounded-md text-white transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-100">
                        <i class="fas fa-search mr-2"></i>Lihat
                    </a>
                    <a href="{{ route('tampil.artikel', ['id' => $a->id]) }}"
                        class="p-2 px-5 bg-slate-900 hover:bg-slate-800 rounded-md text-white transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-100">
