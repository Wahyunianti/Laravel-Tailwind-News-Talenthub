...
@section('content')
<div data-aos="fadeIn" class="flex flex-col xl:flex-row h-auto w-full p-10 gap-7 justify-around">
    <div class="flex flex-col h-40 w-full border shadow-sm rounded-md p-5 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-100">
        ...
        <p class="text-3xl font-semibold text-right">{{ $ctu }}</p>
    </div>
    <div class="flex flex-col h-40 w-full border shadow-sm rounded-md p-5 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-100">
        <div class="flex flex-row justify-between h-full">
        ...
        <p class="text-3xl font-semibold text-right">{{ $cta }}</p>
    </div>
    <div class="flex flex-col h-40 w-full border shadow-sm rounded-md p-5 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-100">
        <div class="flex flex-row justify-between h-full">
        ...
        <p class="text-3xl font-semibold text-right">{{ $cti }}</p>
    </div>
