                        ...
                        <div class="flex flex-row mx-5 lg:mx-10 mt-10  p-0 md:p-5 w-full rounded-lg">
                            <div class="flex flex-col  w-full ">
                                <div
                                    ...
                                    @foreach($tag as $tg)
                                    <a href="" class="text-md ml-10 my-0 font-normal hover:text-blue-500">{{$tg->nama}}</a>
                                    @endforeach
                            ...
                            class="h-60 object-cover w-full md:w-60 rounded-l-md">
                            @else
                            ...
                            @endif
                                    ...
                                    <div class="flex w-96 h-full flex-col p-5">
                                        ...
                                        <a href="{{ route('view.artikel', ['id' => $a->id]) }}"
                                ...
                                <div class="flex h-auto w-auto m-10 mt-5 border-t ">
                                    <ul class="flex w-full flex-col  text-gray-600">
                                        ...
                                        <li
                                            ...
                                            <a href="" class="hover:text-blue-700">{{$k->nama}}</a>
                                        </li>
                                        @endforeach
